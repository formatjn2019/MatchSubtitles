...
class MyTestCase(unittest.TestCase):
    ...
    def test_match_bd_subtitle_force_by_subtitle(self):
        ...
        self.assertEqual(11, move_media_subtitle_to_new_path(media_subtitle_dic,{order+1:media_list[order] for order in range(len(media_list))},r"H:\videos\为美好的世界献上祝福1","为美好的世界献上祝福S01N","",only_show=False))
        # (media_subtitle_dic, only_show=False))

    def test_match_bd_subtitle_force_by_subtitle2(self):
        # # 搜索字幕目录
        subtitle_dic = scanning_subtitle(r"H:\字幕\素晴\[VCB-Studio] Kono Subarashii Sekai ni Shukufuku wo! 2 [Ma10p_1080p]",)
